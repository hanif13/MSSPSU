...
// หน้ารายละเอียดวารสาร พร้อมรูปปก
// ============================================

import { notFound } from "next/navigation";
import Link from "next/link";
import { ArrowLeft, Calendar, FileText, Share2 } from "lucide-react";
import { getJournalBySlug, journals } from "@/lib/mockData";
...
export default async function JournalDetailPage({ params }: JournalPageProps) {
    ...
    // Get other journals
    const otherJournals = journals.filter(j => j.id !== journal.id).slice(0, 2);
                    ...
                    <div className="mt-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            {otherJournals.map((other) => (
                                <Link key={other.id} href={`/annur-journal/${other.slug}`}>
