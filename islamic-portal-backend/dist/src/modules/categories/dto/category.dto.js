...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: ['article', 'video', 'journal', 'salam'] }),
    (0, class_validator_1.IsEnum)(['article', 'video', 'journal', 'salam']),
    __metadata("design:type", String)
...
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ enum: ['article', 'video', 'journal', 'salam'] }),
    (0, class_validator_1.IsEnum)(['article', 'video', 'journal', 'salam']),
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
